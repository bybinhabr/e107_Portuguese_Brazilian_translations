...
define("LAN_393", "Resposta Rápida");
define("LAN_394", "Visualização");
...
define("LAN_404", "Não há tema anterior");
define("LAN_405", "Não há tema seguinte");
...
define("LAN_413", "Relatório");
define("LAN_414", "Relatar esse debate para um moderador");
define("LAN_415", "Título do debate");
define("LAN_416", "Informe seu relatório");
define("LAN_417", "O administrador saberá sobre esse debate. Você pode afixar uma explicação da mensagem que você achou ser desagradável.");
define("LAN_418", "<b>NãO</b> use esse formulário para contatar o administrador por qualquer outra razão.");
define("LAN_419", "Enviar Relatório");
define("LAN_420", "Clique para ver a postagem");
define("LAN_421", "Debate de Fórum relatado de");
define("LAN_422", "Essa postagem foi relatada do site ");
define("LAN_423", "Mensagem não pode ser enviada ");
define("LAN_424", "Postagem foi relatada para o moderador.<br />Obrigado.");
define("LAN_425", "Mensagem de: ");
define("LAN_426", "Relatando postagem no tópico: ");
define("LAN_427", "Erro enviando e-mail");
define("LAN_428", "Postagem foi relatada");
define("LAN_429", "Clique aqui para voltar para o fórum");
define("LAN_430", "Enquete");
define("FORLAN_26", "Réplica deletada");
