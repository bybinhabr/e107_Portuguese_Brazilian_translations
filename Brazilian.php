...
define("CORE_LC", "pt");
define("CORE_LC2", "br");
define("CORE_LAN1", "Erro: Faltando arquivos do tema. \\n\\nMude o tema usado em suas preferências (Área de administração) ou faça upload dos arquivos do tema atual para o servidor.");
...
define("LAN_NO_PERMISSIONS", "Você não tem permissão para ver esta página.");
...
define("LAN_EMAIL_SUBS", "-endereço de email-");
...
define("LAN_LOGIN", "Logar");
define("LAN_LOGOUT", "Deslogar");
define("LAN_SETTINGS", "Configurações");
define("LAN_PASSWORD", "Senha");
define("LAN_INCORRECT_PASSWORD", "Senha incorreta");
